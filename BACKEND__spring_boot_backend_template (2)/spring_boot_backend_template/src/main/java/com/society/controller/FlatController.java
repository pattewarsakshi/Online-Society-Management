...
public class FlatController {
 ...
 // ✅ GET ALL VACANT FLATS OF SOCIETY
    @GetMapping("/society/{societyId}/vacant")
    public ResponseEntity<List<Flat>> getVacantFlats(@PathVariable Integer societyId) {
        List<Flat> vacantFlats = flatService.getFlatsBySociety(societyId);
        return ResponseEntity.ok(vacantFlats);
    }
}
