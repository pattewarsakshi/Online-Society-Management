...
public class AdminUserController {
    ...
    //============================================
    @PostMapping("/{societyId}/guards")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<String> createGuard(
            @PathVariable Long societyId,
            @RequestBody @Valid GuardRegisterRequestDto request
    ) {
        userService.createGuard(societyId, request);
        return ResponseEntity.ok("Guard created successfully");
    }
