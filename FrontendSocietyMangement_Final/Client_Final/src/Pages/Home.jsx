...
const Home = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            description: 'Allocate and track parking slots, manage visitor parking, and reduce conflicts.'
        },
        {
            icon: <svg className="feature-svg-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: 'Track, assign, and resolve maintenance requests and complaints in real-time.'
        },
        {
            icon: <svg className="feature-svg-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: 'Keep residents informed with event calendars and instant announcements.'
        },
        {
            icon: <svg className="feature-svg-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            description: 'Manage maintenance fees, dues, and online payment tracking seamlessly.'
        }
    ];
        ...
        <div className="home-container">
            ...
            <section className="hero-section">
                ...
                <div className="hero-content">
                    ...
                    <p className="hero-subtitle">
                        Manage residents, amenities, complaints, parking & events — all in one place.
                    </p>
            ...
            <section className="events-section">
                <div className="section-container">
                    ...
                    <p className="section-subtitle">Manage Society Events Effortlessly</p>
                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-links">
                            <div className="footer-column">
                                ...
                                <a href="#demo" onClick={(e) => { e.preventDefault(); navigate('/demo'); }}>Demo</a>
                            </div>
                            <div className="footer-column">
                                <h4>Company</h4>
